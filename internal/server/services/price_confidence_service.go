...
// PriceConfidenceService defines confidence score calculations for price reports
type PriceConfidenceService interface {
	CalculatePriceConfidence(productID, supermarketID uuid.UUID) (float64, error)
	UpdatePriceConfidence(price *models.Price) error
